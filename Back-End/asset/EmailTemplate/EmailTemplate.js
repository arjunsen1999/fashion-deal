...
const EmailTemplate = (link) =>{
    ...
    <!-- LOGO -->
    <tr>
      <td bgcolor="#2E6F4B" align="center">
        <table
          border="0"
          cellpadding="0"
          cellspacing="0"
    ...
    <tr>
      <td bgcolor="#2E6F4B" align="center" style="padding: 0px 10px 0px 10px">
        <table
          border="0"
          cellpadding="0"
          cellspacing="0"
        ...
        >
          ...
          <tr>
            <td
              ...
              "
            >
              <p style="margin: 0">Cheers,<br />Fashion Deal Teams</p>
            </td>
          </tr>
        </table>
      </td>
        ...
        >
          <tr>
            ...
            >
              ...
              <p style="margin: 0">
                <a href="#" target="_blank" style="color: #2E6F4B"
